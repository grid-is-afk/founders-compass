...
import { SixCsReconcileCard } from "@/components/clients/q2/SixCsReconcileCard";
...
const PROVE_CHECKLIST: ProveItem[] = [
  { key: "q4_prove_add_assets", group: "Data & Documents", label: "Add assets to data room" },
  { key: "q4_prove_collect_docs", group: "Data & Documents", label: "Collect year-end supporting documents" },
  { key: "q4_prove_six_cs", group: "Annual Alignment", label: "Review and align to Six C's" },
  { key: "q4_prove_annual_plan", group: "Annual Alignment", label: "Review annual progress & set next-year plan" },
];
...
export function ProveQ4Panel({ clientId, nextPhase, onPhaseComplete }: ProveQ4PanelProps) {
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          Document your year-end foundation and align with your annual Six C's baseline.
        </p>
      </div>
