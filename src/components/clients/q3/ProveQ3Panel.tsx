...
const PROVE_CHECKLIST: ProveItem[] = [
  { key: "q3_prove_add_assets", group: "Data & Documents", label: "Add assets to data room" },
  { key: "q3_prove_collect_docs", group: "Data & Documents", label: "Collect supporting documents" },
  { key: "q3_prove_six_cs", group: "Alignment", label: "Review and align to Six C's" },
  { key: "q3_prove_quarter_plan", group: "Alignment", label: "Review & Maintain current quarter plan" },
];
...
export function ProveQ3Panel({ clientId, nextPhase, onPhaseComplete }: ProveQ3PanelProps) {
